...
SEG_BEGIN("MU:a_gate#001@186-194");
  busy_wait_seconds(C3);
SEG_END("MU:a_gate#001@186-194");
...
SEG_BEGIN("MU:b_left#001@200-204");
  busy_wait_seconds(C4);
SEG_END("MU:b_left#001@200-204");
...
SEG_BEGIN("MU:c_right#001@210-214");
  busy_wait_seconds(C5);
SEG_END("MU:c_right#001@210-214");
...
SEG_BEGIN("MU:d_merge#001@220-229");
  busy_wait_seconds(C6);
SEG_END("MU:d_merge#001@220-229");
...
SEG_BEGIN("MU:e_tail#001@235-237");
  busy_wait_seconds(C7);
SEG_END("MU:e_tail#001@235-237");
...
SEG_BEGIN("MU:filler_early_01#001@244-246");
  busy_wait_seconds(C8);
SEG_END("MU:filler_early_01#001@244-246");
...
SEG_BEGIN("MU:filler_early_02#001@252-254");
  busy_wait_seconds(C9);
SEG_END("MU:filler_early_02#001@252-254");
...
SEG_BEGIN("MU:filler_early_03#001@260-262");
  busy_wait_seconds(C10);
SEG_END("MU:filler_early_03#001@260-262");
...
SEG_BEGIN("MU:filler_early_04#001@268-270");
  busy_wait_seconds(C11);
SEG_END("MU:filler_early_04#001@268-270");
...
SEG_BEGIN("MU:filler_mid_01#001@277-280");
  busy_wait_seconds(C12);
SEG_END("MU:filler_mid_01#001@277-280");
...
SEG_BEGIN("MU:filler_mid_02#001@286-289");
  busy_wait_seconds(C13);
SEG_END("MU:filler_mid_02#001@286-289");
...
SEG_BEGIN("MU:filler_mid_03#001@295-298");
  busy_wait_seconds(C14);
SEG_END("MU:filler_mid_03#001@295-298");
...
SEG_BEGIN("MU:filler_mid_04#001@304-307");
  busy_wait_seconds(C15);
SEG_END("MU:filler_mid_04#001@304-307");
...
SEG_BEGIN("MU:filler_late_01#001@314-316");
  busy_wait_seconds(C16);
SEG_END("MU:filler_late_01#001@314-316");
...
SEG_BEGIN("MU:filler_late_02#001@322-324");
  busy_wait_seconds(C17);
SEG_END("MU:filler_late_02#001@322-324");
...
SEG_BEGIN("MU:filler_late_03#001@330-332");
  busy_wait_seconds(C18);
SEG_END("MU:filler_late_03#001@330-332");
...
SEG_BEGIN("MU:filler_late_04#001@338-340");
  busy_wait_seconds(C19);
SEG_END("MU:filler_late_04#001@338-340");
...
SEG_BEGIN("MU:main#002@371-390");
  busy_wait_seconds(C2);
SEG_END("MU:main#002@371-390");
