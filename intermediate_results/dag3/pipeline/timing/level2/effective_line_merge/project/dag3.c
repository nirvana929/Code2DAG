...
SEG_BEGIN("MU:a_head#001@109-112");
  busy_wait_seconds(C4);
SEG_END("MU:a_head#001@109-112");
...
SEG_BEGIN("MU:b_tail#001@117-120");
  busy_wait_seconds(C5);
SEG_END("MU:b_tail#001@117-120");
...
SEG_BEGIN("MU:filler_c#001@125-127");
  busy_wait_seconds(C6);
SEG_END("MU:filler_c#001@125-127");
...
SEG_BEGIN("MU:filler_d#001@132-134");
  busy_wait_seconds(C7);
SEG_END("MU:filler_d#001@132-134");
...
SEG_BEGIN("MU:filler_e#001@139-141");
  busy_wait_seconds(C8);
SEG_END("MU:filler_e#001@139-141");
...
SEG_BEGIN("MU:late_f#001@146-149");
  busy_wait_seconds(C9);
SEG_END("MU:late_f#001@146-149");
