...
SEG_BEGIN("MU:filler_01#001@148-150");
  busy_wait_seconds(C2);
SEG_END("MU:filler_01#001@148-150");
...
SEG_BEGIN("MU:filler_02#001@155-157");
  busy_wait_seconds(C3);
SEG_END("MU:filler_02#001@155-157");
...
SEG_BEGIN("MU:filler_03#001@162-164");
  busy_wait_seconds(C4);
SEG_END("MU:filler_03#001@162-164");
...
SEG_BEGIN("MU:filler_04#001@169-171");
  busy_wait_seconds(C5);
SEG_END("MU:filler_04#001@169-171");
...
SEG_BEGIN("MU:filler_05#001@176-178");
  busy_wait_seconds(C6);
SEG_END("MU:filler_05#001@176-178");
...
SEG_BEGIN("MU:filler_06#001@183-185");
  busy_wait_seconds(C7);
SEG_END("MU:filler_06#001@183-185");
...
SEG_BEGIN("MU:filler_07#001@190-192");
  busy_wait_seconds(C8);
SEG_END("MU:filler_07#001@190-192");
...
SEG_BEGIN("MU:filler_08#001@197-199");
  busy_wait_seconds(C9);
SEG_END("MU:filler_08#001@197-199");
...
SEG_BEGIN("MU:filler_09#001@204-206");
  busy_wait_seconds(C10);
SEG_END("MU:filler_09#001@204-206");
...
SEG_BEGIN("MU:filler_10#001@211-213");
  busy_wait_seconds(C11);
SEG_END("MU:filler_10#001@211-213");
...
SEG_BEGIN("MU:a_chain_run#001@219-221");
  busy_wait_seconds(C12);
SEG_END("MU:a_chain_run#001@219-221");
  pthread_mutex_unlock(&mutex_12);
  pthread_mutex_lock(&mutex_13);
SEG_BEGIN("MU:a_chain_run#002@222-224");
  busy_wait_seconds(C13);
SEG_END("MU:a_chain_run#002@222-224");
  pthread_mutex_unlock(&mutex_13);
  pthread_mutex_lock(&mutex_14);
SEG_BEGIN("MU:a_chain_run#003@225-227");
  busy_wait_seconds(C14);
SEG_END("MU:a_chain_run#003@225-227");
...
SEG_BEGIN("MU:main#001@234-237");
  init_matrices();
  busy_wait_seconds(C1);
SEG_END("MU:main#001@234-237");
  pthread_mutex_unlock(&mutex_01);
SEG_BEGIN("SEG:main#002@238-252");
...
SEG_END("SEG:main#002@238-252");
SEG_BEGIN("SEG:main#003@253-253");

SEG_END("SEG:main#003@253-253");
SEG_BEGIN("SEG:main#004@254-265");
...
SEG_END("SEG:main#004@254-265");
  pthread_mutex_lock(&mutex_15);
SEG_BEGIN("MU:main#005@266-268");
  busy_wait_seconds(C15);
SEG_END("MU:main#005@266-268");
