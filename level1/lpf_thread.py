...
def main() -> int:
    ...
    ap.add_argument("--project", required=True, help="Project name under time_analysis_level1/<project>/")
    ...
    stage_dir = base_dir / "intermediate_results" / base_name / "level1" / "stage1"
    ta_dir = base_dir / "intermediate_results" / base_name / "level1" / "timing" / args.project
    ...
    out_dir = base_dir / "intermediate_results" / base_name / "level1" / "schedule" / "lpf_thread"
