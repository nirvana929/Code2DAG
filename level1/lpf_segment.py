...
def main() -> int:
    ...
    timing_dir = base_dir / "intermediate_results" / base_name / "level1" / "timing" / args.project
    ...
    out_dir = base_dir / "intermediate_results" / base_name / "level1" / "schedule" / ("lpf_segment_entry" if args.only_entry_functions else "lpf_segment")
