...
l1_set_thread_prio_fifo(79);
  ...
  sem_post(&sem_12);
l1_set_thread_prio_fifo(67);

  /* L6 */
  l1_set_thread_prio_fifo(66);
  sem_wait(&sem_11);
...
l1_set_thread_prio_fifo(57);
  ...
  sem_post(&sem_23);
l1_set_thread_prio_fifo(51);

  /* L8 */
  l1_set_thread_prio_fifo(50);
  sem_wait(&sem_24);
  pthread_mutex_lock(&mutex_33);
  busy_wait_seconds(C33);
  pthread_mutex_unlock(&mutex_33);
  sem_post(&sem_27);
l1_set_thread_prio_fifo(28);
...
static void *lane5_fn(void *arg)
{
  ...
  sem_post(&sem_15);
l1_set_thread_prio_fifo(69);

  /* L6 */
  l1_set_thread_prio_fifo(68);
  sem_wait(&sem_14);
...
l1_set_thread_prio_fifo(27);

  l1_set_thread_prio_fifo(24);
