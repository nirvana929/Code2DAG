...
"""Modern DOT/path rendering (for tool and single test use).\n\nnote: GUI and CLI use legacy generate DOT; this renderer is used for minimal snapshots\nOr other tool chain calls, aligned with legacy semantics (exclude/no_externs, etc.).\n"""
...
class DotRenderer :
    """Render `CallGraph` to Graphviz DOT."""
...
__seen_in_path :Optional [Dict [str ,bool ]]=None ,
    ...
    """Snapshot of the outputpath in ASCII form (compatible with legacy)."""
