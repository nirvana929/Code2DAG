...
"""Build reverse index (modernized interface)."""
...
def build_callee_info (graph :CallGraph )->None :
    """Populate `callee_calls/callee_refs` based on forward calls/references."""
...
def seed_unit_test_graph ()->Dict [str ,Dict [str ,Dict [str ,bool ]]]:
    """Compatible with legacy Minimum data for single test snapshot."""
